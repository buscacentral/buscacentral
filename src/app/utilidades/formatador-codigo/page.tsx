...
export default function FormatadorCodigo() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Formatador de JSON e XML</h1>
      <p className="text-gray-600 mb-8">
        Formate e valide seu JSON ou XML de forma rápida e gratuita.
        Cole o código desorganizado e receba o resultado indentado e legível.
        Ferramenta essencial para desenvolvedores e analistas de sistemas.
      </p>
