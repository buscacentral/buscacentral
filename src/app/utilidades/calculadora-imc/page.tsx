...
export default function CalculadoraIMC() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Calculadora de IMC</h1>
      <p className="text-gray-600 mb-8">
        Calcule seu Índice de Massa Corporal (IMC) e descubra se seu peso está
        na faixa saudável segundo a Organização Mundial da Saúde. Informe seu
        peso e altura e veja o resultado instantaneamente.
      </p>
