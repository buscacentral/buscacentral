...
export default function FinanciamentoCarro() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Simulador de Financiamento de Carro</h1>
      <p className="text-gray-600 mb-8">
        Simule o financiamento do seu veículo e descubra o valor das parcelas,
        total de juros e custo efetivo. Compare os sistemas Price e SAC para
        escolher a melhor opção antes de fechar negócio.
      </p>
