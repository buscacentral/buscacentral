    ...
    <main>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="prose prose-slate max-w-none text-slate-600">
          ...
          <p className="mb-4 leading-relaxed">
            Todas as nossas {mainTools.length > 0 ? '66' : ''} ferramentas estão disponíveis gratuitamente 24 horas por dia, 7 dias por semana. Não exigimos criação de conta, login com redes sociais ou assinaturas premium. Basta acessar a página da utilidade que você precisa e utilizá-la imediatamente.
          </p>
